...
const I18N = {
    ...
    costColNote: '비고',
    costFnd: '파운데이션',
    costFndNote: '기관·계열별 차이',
    costUg: '학부 (연간)',
    costUgNote: '실험·임상 계열이 상단',
    costLiveLdn: '생활비 (런던)',
    costLiveOut: '생활비 (런던 외)',
    costLiveNote: '비자 증빙 기준액',
    perMonth: '월',
    costFoot: '생활비는 실제 지출 추정이 아니라 학생 비자에서 최대 9개월분을 증빙하도록 정한 기준액입니다. 학비는 대학이 매년 새로 정하므로 지원 전 해당 과정 페이지에서 확인하세요.',
    ...
    costColNote: "Notes",
    costFnd: "Foundation",
    costFndNote: "Varies by provider and subject",
    costUg: "Bachelor's (per year)",
    costUgNote: "Lab and clinical subjects sit at the top",
    costLiveLdn: "Living costs (London)",
    costLiveOut: "Living costs (outside London)",
    costLiveNote: "Visa maintenance requirement",
    perMonth: "per month",
    costFoot: "The living figures are not spending estimates: they are the amounts the student visa requires you to show, for up to nine months. Universities reset tuition each year, so check the course page before you apply.",
