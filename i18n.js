...
const I18N = {
    ...
    ugPrepTitle: '학부 지원 준비 가이드',
        ...
        ownRec: '<strong class="text-ink2">추천</strong> 목표 대학 캠퍼스에서 미리 생활하며 스스로 성적 · 생활을 관리할 수 있는 내신 상위권 학생. 요건은 학교마다 다릅니다.',
        guTitle: '입학보장형 대학부설',
        guSub: '진학 보장으로 안전하게',
    ...
    ugPrepTitle: "Preparing your application",
        ...
        ownRec: '<strong class="text-ink2">Best for</strong> self-directed students in the top grade band who want campus life at their target university early. Requirements vary by university.',
