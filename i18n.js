...
const I18N = {
    ko: {
        ...
        pmFlow: [['학사 졸업', '전공이 달라도 가능'], ['프리마스터', '전공 과목 + 논문 작성법'], ['석사 본과정', '수료 성적으로 진입']],
        pmSpec: [['대상', '전공이 다르거나 GPA가 요건에 못 미칠 때'], ['기간', '3 Terms(9 · 1월) 또는 2 Terms(1 · 3월)'], ['영어', '과정 중 성적으로 석사용 IELTS 대체']],
        pmNote: '2 Terms는 IELTS를 0.5점 이상 더 요구하고, IELTS for UKVI 성적이 필요합니다. 모든 전공에 개설되지는 않으며 진학 보장형은 대학 선택이 제한적입니다.',
        psTitle: 'Pre-sessional (프리세셔널 영어)',
        psSub: '대학이 직접 운영하는 학업 영어 과정',
        psFlow: [['조건부 오퍼', 'IELTS만 조금 부족'], ['프리세셔널', '대학 부설 학업 영어'], ['석사 본과정', 'Final Test 통과 시']],
        psSpec: [['대상', '오퍼는 받았지만 영어 점수만 부족할 때'], ['기간', '점수 차이에 따라 4 ~ 46주'], ['영어', '통과하면 IELTS 재응시 · 제출 면제']],
        psNote: '일반 IELTS가 아닌 IELTS for UKVI 성적이 필요하고, 과정이 끝난 뒤 비자 연장이 필요할 수 있습니다.',
        ...
        cDocChips: ['영문 성적증명서', '영문 학위 · 졸업(예정)증명서', '학업계획서 · 자기소개서', '추천서 1~2부', '영문 이력서', '여권 사본', '공인 영어성적'],
        cDocsNote: '공인 영어성적은 없어도 조건부 입학으로 지원한 뒤 나중에 제출할 수 있습니다.',
        ...
        timingSpec: [['방식', '롤링 어드미션 · 정원이 차는 순서대로 마감'], ['오픈', '입학 1년 전(전년도 9 ~ 10월)'], ['준비', '서류에 최소 1 ~ 2개월']],
        timingNote: '인기 과정은 조기 마감되므로 빨리 지원할수록 합격과 장학금에 유리합니다.',
        ...
        /* 진입 경로 카드: 체브론 3단(flow) + 스펙 3줄(spec) + 주의 한 줄(note).
           긴 불릿 목록을 대신한다. 배열 형태 그대로 flowHTML·specHTML에 넘어간다. */
        routeFnd: {
            flow: [['고2 수료', '지원 자격 충족'], ['파운데이션 1년', '전공 기초 + 영어'], ['학사 1학년', '연계 대학 진학']],
            spec: [['대상', '고2 수료 이상 · 가장 빠른 시작'], ['영어', 'IELTS(UKVI) 4.5 ~ 5.5'], ['전공', '인문 ~ 이공 전반, 선택 폭 최대']],
            note: '수료 성적을 충족하면 연계 대학 진학을 보장하는 과정이 많습니다.'
        },
        routeIyo: {
            flow: [['고교 졸업', '대학 1년 이수자 포함'], ['IYO 1년', '학부 1학년 과정'], ['학사 2학년', '바로 편입']],
            spec: [['대상', '고교 졸업(예정) · 내신 요건 충족'], ['영어', 'IELTS(UKVI) 5.5 ~ 6.0'], ['전공', '경영 · 공학 · 컴퓨팅 중심']],
            note: '편입 구조라 개설 전공이 제한적입니다. 대신 총 유학 기간이 1년 짧습니다.'
        },
        routeDir: {
            flow: [['해외고 · 국제학교', '정규 과정 이수'], ['UCAS 지원', '최대 5개교'], ['학사 1학년', '준비과정 없이 직행']],
            spec: [['대상', 'A-level · IB 성적 보유자'], ['영어', 'IELTS 6.5 ~ 7.0+'], ['특징', '옥스브리지 · 임페리얼 · LSE는 이 경로만']],
            note: '진행 방식이 파운데이션 · IYO와 달라 <a href="https://www.ucas.com/" target="_blank" rel="noopener" class="underline font-semibold">UCAS 공식 안내</a>를 따로 확인해야 합니다.'
        },
        ...
        costTitle: '학비와 생활비',
    costSub: '파운데이션부터 학위까지 드는 비용입니다. 원화는 조회 시점 환율로 함께 보여드립니다.',
    costColItem: '구분',
    costColRange: '금액',
    costColNote: '비고',
    costFnd: '파운데이션',
    costFndNote: '운영사보다 대학이 가릅니다',
    costUg: '학부 (연간)',
    costUgNote: '의대·옥스퍼드는 £62,820까지',
    costLiveLdn: '생활비 (런던)',
    costLiveOut: '생활비 (런던 외)',
    costLiveNote: '비자 증빙 기준액',
    perMonth: '월',
    costFoot: '학비 범위는 2026-27 공시를 확인한 값이고 의대·치대·수의대는 이보다 위입니다. 생활비는 실제 지출 추정이 아니라 학생 비자에서 최대 9개월분을 증빙하도록 정한 기준액입니다. 학비는 대학이 매년 새로 정하므로 지원 전 해당 과정 페이지에서 확인하세요.',
    ugPrepTitle: '학부 지원 준비 가이드',
        ugDocsTitle: '기본 준비 서류',
        ugDocsSub: '파운데이션 · IYO 지원의 공통 기본 서류입니다.',
        ugDocChips: ['영문 고교 성적증명서', '영문 재학 · 졸업(예정)증명서', '여권 사본', 'IELTS for UKVI', '자기소개 · 학업 계획'],
        ugDocsNote: '검정고시는 성적증명으로 대체합니다. IELTS는 없어도 조건부 오퍼를 받고 나중에 제출할 수 있고, 자기소개 · 학업 계획은 기관에 따라 요구합니다.',
        ugTimingTitle: '지원 타이밍',
        ugTimingSub: '파운데이션 · IYO는 대학 본과와 입학 시점 구조가 다릅니다.',
        ugTimeSpec: [['입학', '9월 외에 1월 · 4월 등 복수 시점'], ['지원', '인기 과정은 6개월 ~ 1년 전 마감'], ['비자', '수속에 1 ~ 2개월, 역산해 준비']],
        ...
        chipOwn: '대학부설 · 자체형',
        chipGuar: '대학부설 · 입학보장형',
        pfOpenLabel: '눌러서 사설 파운데이션 기관 보기',
        pfCloseLabel: '접기',
        pvTitle: '사설 파운데이션',
        pvSub: '오픈 초이스 · 소수정예 관리형',
        pvSpec: [['입학', '연 2회 (9월 · 1월)'], ['요건', 'IELTS 4.5 ~ 5.5 · 내신 문턱 낮음'], ['진학', '대부분의 대학에 오픈 초이스 지원']],
        pvRec: '<strong class="text-ink2">추천</strong> 목표 학교 · 전공이 아직 정해지지 않았거나, 한 반 10명 담임제로 성적 · 생활 관리를 받고 싶은 학생. 내신이 낮아도 상위권을 노려볼 수 있습니다.',
        ownTitle: '자체 대학부설',
        ownSub: '상위권 대학 캠퍼스에서 수학',
        ownSpec: [['입학', '연 1회 (9월)'], ['요건', '내신 3~4등급 이상 · IELTS 5.5 이상'], ['진학', '보장 없음 · 성적 우수 시 평균 50%']],
        ownRec: '<strong class="text-ink2">추천</strong> 목표 대학 캠퍼스에서 미리 생활하며 스스로 성적 · 생활을 관리할 수 있는 내신 상위권 학생. 요건은 학교마다 다릅니다. 다만 일부 대학(웨스트민스터 · 버크벡 등)의 파운데이션은 학위에 통합된 Year 0 과정이라 그 대학 진학 전용이며, KCL처럼 타 대학 통합형을 받지 않는 학교에는 수료 후에도 지원할 수 없습니다.',
        guTitle: '입학보장형 대학부설',
        guSub: '진학 보장으로 안전하게',
        guSpec: [['입학', '연 2회 (9월 · 1월)'], ['요건', '내신 5~6등급 이상 · IELTS 5.0 ~ 5.5'], ['진학', '성적 충족 시 보장 (85~95%)']],
        guRec: '<strong class="text-ink2">추천</strong> 처음 정한 대학 · 일부 파트너 대학 밖으로 옮기기는 어렵지만, 중상위권 학교에 안전하게 가고 싶은 학생.',
        listTitle: (label) => `${label ? label + ' 계열 ' : ''}추천 영국 대학`,
        listSub: (label) => `각 카드에 ${label ? '<strong class="text-ink2">' + label + ' 계열 전공명</strong>' : '진학 가능한 전공명'}을 표시했습니다. 대학 이름을 누르면 소개와 진입 경로가 열립니다.`,
        filterAll: '전체',
    ...
    en: {
        ...
        uniDetailBtn: "View this university",
        ...
        pmFlow: [["Bachelor's degree", "a different subject is fine"], ["Pre-master's", "subject modules + research skills"], ["The master's", "on your completion grades"]],
        pmSpec: [["Who", "A different subject, or a GPA below the requirement"], ["Length", "Three terms (Sep · Jan) or two terms (Jan · Mar)"], ["English", "Course results can replace IELTS for entry"]],
        pmNote: "The two-term version asks for IELTS at least 0.5 higher, and IELTS for UKVI is required. Not every subject is offered, and progression-guaranteed routes limit your choice of university.",
        psTitle: "Pre-sessional English",
        psSub: "Academic English run by the university itself",
        psFlow: [["Conditional offer", "only the English is short"], ["Pre-sessional", "academic English at the university"], ["The master's", "on passing the final test"]],
        psSpec: [["Who", "You hold an offer but your IELTS falls short"], ["Length", "4 to 46 weeks, set by the score gap"], ["English", "Passing removes the IELTS requirement"]],
        psNote: "IELTS for UKVI is required rather than the standard test, and you may need to extend your visa when the course ends.",
        ...
        cDocChips: ["Academic transcript", "Degree or graduation certificate", "Personal statement (SOP)", "One or two references", "CV in English", "Passport copy", "English test result"],
        cDocsNote: "Without an English test result you can still apply for a conditional offer and submit it later.",
        ...
        timingSpec: [["How", "Rolling admission — places close as they fill"], ["Opens", "A year before entry (Sep–Oct the year before)"], ["Prepare", "At least one to two months of documents"]],
        timingNote: "Popular courses close early, so applying as soon as you can helps with both offers and scholarships.",
        ...
        routeFnd: {
            flow: [["End of year 11", "you already qualify"], ["Foundation, 1 year", "subject basics + English"], ["Degree year 1", "at the partner university"]],
            spec: [["Who", "From the end of year 11 — the earliest start"], ["English", "IELTS (UKVI) 4.5–5.5"], ["Subjects", "Humanities to engineering — the widest choice"]],
            note: "Many courses guarantee progression to the partner university once you meet the completion grades."
        },
        routeIyo: {
            flow: [["School leaver", "including a year of university"], ["IYO, 1 year", "the year-1 curriculum"], ["Degree year 2", "straight in"]],
            spec: [["Who", "(Expected) school graduation and school grades"], ["English", "IELTS (UKVI) 5.5–6.0"], ["Subjects", "Mostly business, engineering, computing"]],
            note: "Being a transfer route keeps the subject list short — but it takes a year off the whole plan."
        },
        routeDir: {
            flow: [["School abroad", "A-level or IB"], ["UCAS", "up to five universities"], ["Degree year 1", "no preparatory year"]],
            spec: [["Who", "Students holding A-level or IB results"], ["English", "IELTS 6.5–7.0+"], ["Note", "The only route into Oxbridge, Imperial and LSE"]],
            note: 'It works differently from the foundation and IYO routes, so check the <a href="https://www.ucas.com/" target="_blank" rel="noopener" class="underline font-semibold">official UCAS guidance</a> separately.'
        },
    ...
    costSub: "What the route costs, from foundation through to the degree, with the won equivalent at today's rate.",
    costColItem: "Item",
    costColRange: "Amount",
    costColNote: "Notes",
    costFnd: "Foundation",
    costFndNote: "Set by the university, not the provider",
    costUg: "Bachelor's (per year)",
    costUgNote: "Medicine and Oxford reach £62,820",
    costLiveLdn: "Living costs (London)",
    costLiveOut: "Living costs (outside London)",
    costLiveNote: "Visa maintenance requirement",
    perMonth: "per month",
    costFoot: "The tuition range comes from published 2026–27 rates; medicine, dentistry and veterinary sit above it. The living figures are not spending estimates: they are the amounts the student visa requires you to show, for up to nine months. Universities reset tuition each year, so check the course page before you apply.",
    ugPrepTitle: "Preparing your application",
        ...
        ugDocChips: ["School transcript in English", "Enrolment or graduation certificate", "Passport copy", "IELTS for UKVI", "Personal statement and study plan"],
        ugDocsNote: "The equivalency-exam certificate stands in for a school transcript. Without IELTS you can still take a conditional offer and submit later, and only some providers ask for the personal statement.",
        ugTimingTitle: "Timing",
        ugTimingSub: "Foundation and IYO intakes run on a different calendar from the degree itself.",
        ugTimeSpec: [["Intakes", "January and April as well as September"], ["Apply", "Popular courses fill six months to a year ahead"], ["Visa", "One to two months — work backwards"]],
        ...
        pfOpenLabel: "Open the list of independent providers",
        pfCloseLabel: "Close",
        pvTitle: "Independent foundation",
        pvSub: "Open choice · small supervised classes",
        pvSpec: [["Intakes", "Twice a year (September · January)"], ["Entry", "IELTS 4.5–5.5 · accessible grade requirements"], ["Progression", "Open choice across most universities"]],
        pvRec: '<strong class="text-ink2">Best for</strong> students who have not settled on a university or subject, or who want classes of ten with a form tutor overseeing grades and welfare. Modest grades can still reach high.',
        ownTitle: "University-run foundation",
        ownSub: "Study on the campus of a leading university",
        ownSpec: [["Intakes", "Once a year (September)"], ["Entry", "Grade band 3–4 or above · IELTS 5.5+"], ["Progression", "Not guaranteed · about 50% on strong results"]],
        ownRec: '<strong class="text-ink2">Best for</strong> self-directed students in the top grade band who want campus life at their target university early. Requirements vary by university. Note that some universities (e.g. Westminster, Birkbeck) run their foundation as an integrated Year 0 within the degree — it leads only into that university, and schools like KCL do not accept integrated foundations taken elsewhere.',
        guTitle: "Progression-guaranteed foundation",
        guSub: "The safe route, with a secured place",
        guSpec: [["Intakes", "Twice a year (September · January)"], ["Entry", "Grade band 5–6 or above · IELTS 5.0–5.5"], ["Progression", "Guaranteed on completion grades (85–95%)"]],
        guRec: '<strong class="text-ink2">Best for</strong> students who want a safe, secured route into a solid university — accepting that moving beyond the chosen university and its partners is difficult.',
        listTitle: (label) => `${label ? 'Recommended UK universities — ' + label : 'Recommended UK universities'}`,
        listSub: (label) => `Each card lists ${label ? '<strong class="text-ink2">the ' + label + ' courses you can enter</strong>' : 'the courses you can enter'}. Select a university name for its profile and entry routes.`,
        filterAll: "All",
